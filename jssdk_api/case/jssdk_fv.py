...
class fv_video():
    ...
    def __init__(self,count=0):
        ...
        self.sum_num=0
        p = ParseConfigfile()
        self.url = p.getOptionValue('url', 'fv_url')
        self.new_url,self.params=params2dict(self.url)
        self.app_id=p.getOptionValue('fv_video','app_id')
        self.unit_id=p.getOptionValue('fv_video', 'unit_id')
        self.sign=p.getOptionValue('fv_video', 'sign')
        self.content_type=p.getOptionValue('fv_video','content_type')
