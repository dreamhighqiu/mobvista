...
class net_v3():
    ...
    def __init__(self,count=0):
        ...
        self.sum_num=0
        p = ParseConfigfile()
        self.url = p.getOptionValue('url', 'net_v3')
        self.new_url,self.params=params2dict(self.url)
        self.app_id=p.getOptionValue('net_v3','app_id')
        self.unit_id=p.getOptionValue('net_v3', 'unit_id')
        self.sign=p.getOptionValue('net_v3', 'sign')
        self.content_type=p.getOptionValue('net_v3','content_type')
