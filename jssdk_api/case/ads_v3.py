...
class ads_v3():
    ...
    def __init__(self,count=0):
        ...
        self.sum_num=0
        p = ParseConfigfile()
        self.url = p.getOptionValue('url', 'ads_v3')
        self.new_url,self.params=params2dict(self.url)
        self.app_id=p.getOptionValue('ads_v3','app_id')
        self.unit_id=p.getOptionValue('ads_v3', 'unit_id')
        self.sign=p.getOptionValue('ads_v3', 'sign')
        self.client_ip=p.getOptionValue('common','client_ip')
    ...
    def change_params(self):
        ...
        self.params['client_ip']=self.client_ip
