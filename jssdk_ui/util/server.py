...
class Server:
	...
	def create_command_list(self,i):
		...
		command = "appium -p "+str(appium_port_list[i])+" -bp "+str(bootstrap_port_list[i])+" -U "+device_list[i]+" " \
																												  "--no-reset --session-override --log E:/jssdk_ui/log/test02.log"
		#appium -p 4723 -bp 4726 -U 127.0.0.1:62001 --no-reset --session-override --log E:/jssdk_ui/log/test01.log
